...
| 品目 | 外注単価 | 院内原価 |
|---|---:|---:|
| CAD/CAM冠 | 9,000円 | 1,500円 |
| CAD/CAMインレー・アンレー | 7,500円 | 1,500円 |
| Zrクラウン・インレー・アンレー | 12,000円 | 4,580円 |

メイン画面の「外注価格」で、採用単価・成田デンタル・東洋デンタルを切り替えて再計算できます。「外注単価比較」タブでは各社料金を品目別に比較できます。保守・標準・上限のシナリオ区分は使用しません。
